...
<body>
  ...
  <header id="header">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="#intro" class="scrollto">STUDY OVERSEAS</a></h1>
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li class="menu-has-children"><a href="">Lessons</a>
            <ul>
              <li><a href="#">Listening</a></li>
              <li><a href="#">Reading</a></li>
              <li class="menu-has-children"><a href="#">Writing Task</a>
                <ul>
                  <li><a href="#">Writing Task 1</a></li>
                  <li><a href="#">Writing Task 2</a></li>
                </ul>
              </li>
  ...
  <section id="intro">
    ...
    <div class="intro-text">
      ...
      <a href="#about" class="btn-get-started scrollto">Everyday Vocabulary</a>
    </div>
    
    <div class="product-screens">

      <div class="product-screen-1 wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="0.6s">
        <a href="home"> <img src="img/speak.jpg" alt=""></a>
      </div>

      <div class="product-screen-2 wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="0.6s">
         <a href="home"><img src="img/read.jpg" alt=""></a>
      </div>

      <div class="product-screen-3 wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="0.6s">
        <a href="home"> <img src="img/listen.jpg" alt=""></a>
      </div>
      <div class="product-screen-4 wow fadeInUp" data-wow-duration="0.6s">
        <a href="home"> <img src="img/write.jpg" alt=""></a>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6">
             <div class="box featured wow fadeInLeft">
              ...
              <br>
              <a href="#" class="get-started-btn">More Details</a>
            </div>
          </div>
           <div class="col-lg-6 col-md-6">
